...
public class Customer {
	...
	public Customer(String custName, String custAddr, String custPhone, Double custPayment, String custArea)
	...
	public static void validateName(String custName) throws CustomerExceptionHandler {
		...
		// E.G. Name String must be a minimum of 2 characters and a maximum of 50
		// characters

		if (custName.isEmpty())
			throw new CustomerExceptionHandler("Customer Name NOT specified");
		else if (isNumeric(custName)) {
			throw new CustomerExceptionHandler("Customer Name Contains Numeric");
	...
	public static void validateAddress(String custAddr) throws CustomerExceptionHandler {
		...
		// E.G. Name String must be a minimum of 5 characters and a maximum of 60
		// characters
	...
	public static void validatePhoneNumber(String custPhone) throws CustomerExceptionHandler {
		...
		// E.G. Name String must be a minimum of 7 characters and a maximum of 15
		// characters
		int n = custPhone.length();
		if (custPhone.isEmpty())
			throw new CustomerExceptionHandler("Customer PhoneNumber NOT specified");
		else if (!onlyDigits(custPhone,n))
			throw new CustomerExceptionHandler("Customer PhoneNumber Contains Alphabet");
